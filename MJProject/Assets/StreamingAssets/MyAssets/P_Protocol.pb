...
GameRecord2
list (2$.Adoter.Asset.GameRecord.GameElementф
GameElement
	player_id (
nickname (
...
player_brief_list (2.Adoter.Asset.PlayerBrief"є
...
content (
	send_time (
readed (1
attachments (2.Adoter.Asset.MailAttachment"Ї
Player-
...
account (2.Adoter.Asset.Account"Д
WechatAccessToken
access_token (
...
card_color_type (2.Adoter.Asset.CARD_COLOR_TYPE"п
BattleHistoryE
type_t (2.Adoter.Asset.META_TYPE:META_TYPE_SHARE_ROOM_HISTORY
start_index (
	end_index (/
history_list (2.Adoter.Asset.RoomHistory"и
UserRechargeA
...
pai (2.Adoter.Asset.PaiElement.
	...
	ting_pais (2.Adoter.Asset.PaiElement"Д
PaiOperationF
...
pai (2.Adoter.Asset.PaiElement"Ё
...
error_code (2.Adoter.Asset.ERROR_CODE"С
BuySomethingF
type_t (2.Adoter.Asset.META_TYPE:META_TYPE_SHARE_BUY_SOMETHING
mall_id ((
result (2.Adoter.Asset.ERROR_CODE"Т
	LoadSceneA
...
elements (2.Adoter.Asset.LiuJu.LJElementE
	LJElement
	player_id (%
pai (2.Adoter.Asset.PaiElement"И
	PaiNotifyA
...
player_list (2$.Adoter.Asset.RoomInformation.PlayerЛ
Player-
position (2.Adoter.Asset.POSITION_TYPE/
	oper_type (2.Adoter.Asset.GAME_OPER_TYPE-
common_prop (2.Adoter.Asset.CommonProp)
...
max_fan_type (2.Adoter.Asset.FAN_TYPE"ж
...
room_id (3
list (2%.Adoter.Asset.RoomDisMiss.RoomElementА
RoomElement
	player_id (-
position (2.Adoter.Asset.POSITION_TYPE/
	oper_type (2.Adoter.Asset.GAME_OPER_TYPE"Р
	RoomStateA
...
zhuapai (2.Adoter.Asset.PaiElementП
Player
	player_id (-
position (2.Adoter.Asset.POSITION_TYPE
pai_count_inhand (-
...
META_TYPE_C2S_COUNT 
META_TYPE_S2C_BEGINї
META_TYPE_S2C_TICKETЎ
META_TYPE_S2C_SERVER_LISTў
...
META_TYPE_S2C_COMMON_LIMIT  
META_TYPE_S2C_COMMON_REWARDА
META_TYPE_S2C_ROOM_INFOБ!
META_TYPE_S2C_GAME_CALCULATEВ
META_TYPE_S2C_GAME_INFOГ
META_TYPE_S2C_KILL_OUTД
META_TYPE_S2C_ACTIVITYЕ#
META_TYPE_S2C_SYSTEM_BROADCASTЖ 
META_TYPE_S2C_PAI_PUSH_DOWNЗ
META_TYPE_S2C_GAMES_FULLИ$
META_TYPE_S2C_WECHAT_INFOMATIONЙ
META_TYPE_S2C_GAME_STARTК!
META_TYPE_S2C_ROOM_CALCULATEЛ
META_TYPE_S2C_ROOM_DISMISSМ
META_TYPE_S2C_ROOM_STATEН
META_TYPE_S2C_ROOM_HISTORYО
META_TYPE_S2C_ROOM_ALLП
META_TYPE_S2C_ROOM_INР
META_TYPE_S2C_COUNTш
META_TYPE_S2S_REGISTERщ!
META_TYPE_S2S_KICKOUT_PLAYERъ!
META_TYPE_S2S_GMT_INNER_METAы
META_TYPE_S2S_PLAYER_STATEь*l
ACCOUNT_TYPE
ACCOUNT_TYPE_8HERE
ACCOUNT_TYPE_GUEST
ACCOUNT_TYPE_WECHAT
