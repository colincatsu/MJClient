...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void SystemVoid(UnityEngine.GameObject go)
		{
#if THREAD_SAFT || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int SystemInt32(MX.ByteBuffer buffer)
		{
#if THREAD_SAFT || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new EventTriggerListener.VoidDelegate(SystemVoid);
			}
		
		    if (type == typeof(MX.SocketClient.FDelegate))
			{
			    return new MX.SocketClient.FDelegate(SystemInt32);
			}
			...
			{
                return new __Gen_Hotfix_Delegate10(SystemVoid);
            }
