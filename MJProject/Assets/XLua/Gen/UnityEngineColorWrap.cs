...
namespace CSObjectWrap
{
    public class UnityEngineColorWrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "maxColorComponent", get_maxColorComponent);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "LerpUnclamped", LerpUnclamped_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "RGBToHSV", RGBToHSV_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "HSVToRGB", HSVToRGB_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int LerpUnclamped_xlua_st_(RealStatePtr L)
        {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int RGBToHSV_xlua_st_(RealStatePtr L)
        {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int HSVToRGB_xlua_st_(RealStatePtr L)
        {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int get_maxColorComponent(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
