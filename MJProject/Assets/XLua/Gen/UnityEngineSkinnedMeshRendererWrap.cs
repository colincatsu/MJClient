...
namespace CSObjectWrap
{
    public class UnityEngineSkinnedMeshRendererWrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "skinnedMotionVectors", get_skinnedMotionVectors);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "skinnedMotionVectors", set_skinnedMotionVectors);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int get_skinnedMotionVectors(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int set_skinnedMotionVectors(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
