...
namespace CSObjectWrap
{
    public class UnityEngineTransformWrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "hierarchyCapacity", get_hierarchyCapacity);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "hierarchyCount", get_hierarchyCount);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "hierarchyCapacity", set_hierarchyCapacity);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int get_hierarchyCapacity(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int get_hierarchyCount(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int set_hierarchyCapacity(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
